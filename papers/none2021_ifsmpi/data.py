...
class Summary(JsonSerializable):
    ...
    def __init__(self, res_id: str, oifs_runs_task: int, l91_file: str, l137_file: str, oxford_output_path: str, rp_versions: List[ReducedPrecisionVersion]):
        self.res_id = res_id
        self.l91_file = l91_file
        self.l137_file = l137_file
        self.oifs_runs_task = oifs_runs_task
