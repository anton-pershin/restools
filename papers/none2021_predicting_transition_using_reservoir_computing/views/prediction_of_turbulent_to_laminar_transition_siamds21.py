...
import restools
from papers.none2021_predicting_transition_using_reservoir_computing.extensions import is_laminarised
...
if __name__ == '__main__':
    ...
    fig, axes = plt.subplots(len(tasks_esn), 1, figsize=(12, 7), sharex=True, sharey=True)
