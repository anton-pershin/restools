...
if __name__ == '__main__':
    ...
    data = [
        ...
        {'task': 67, 'end_time': 3400},
        {'task': 71, 'end_time': 3500},
        {'task': 72, 'end_time': 3600},
        {'task': 60, 'end_time': 3700},
        {'task': 57, 'end_time': 4000},
    ]
    ...
    fig, axes = plt.subplots(len(data), 2, figsize=(12, 8))
    ...
    plt.savefig('learning_laminar_state_timeseries.png', dpi=200)
