...
class LocalPythonTimeIntegrationGraph(Graph):
    def __init__(self, res, comm, integrator, input_filename, task_prefix=''):
...
class RemotePythonTimeIntegrationGraph(Graph):
    def __init__(self, res, local_comm, remote_comm, integrator, input_filename, task_prefix='',
        ...
        ti_start, ti_end = RemotePythonTimeIntegrationGraph.create_branch(local_comm, remote_comm, integrator,
    ...
    def create_branch(local_comm, remote_comm, integrator_prog: StandardisedIntegrator,
                      ...
                      init_field_at_remote_key=None, output_filenames_key='output_filenames'):
        def task_finished(d):
            time.sleep(2)
        ...
        integrator_edge = StandardisedProgramEdge(integrator_prog, remote_comm,
