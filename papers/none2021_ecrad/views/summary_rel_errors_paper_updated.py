...
if __name__ == '__main__':
    ...
    ifs_data_ref = ERA5Data('/media/tony/Seagate/Leeds/PhD/research/2021-05-18_ecRad_reduced_precision/17-ERA5DataForEcRad/anton_T_t_pl_days.nc',
                            any_ref_nc_file_containing_same_lat_and_lon='/media/tony/Seagate/Leeds/PhD/research/2021-05-18_ecRad_reduced_precision/17-ecRadIntegratedInOpenIFSUpdated/hgom/ecrad_tripleclouds_52bits/sh/0.nc',
...
#        },
    ...
    for q_i in range(n_quantities):
        ...
        axes[q_i].set_ylim((-0.0002, 0.0052))
        axes[q_i].grid()
        axes[q_i].legend()
